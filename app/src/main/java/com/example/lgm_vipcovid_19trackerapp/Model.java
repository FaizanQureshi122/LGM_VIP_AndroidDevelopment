package com.example.lgm_vipcovid_19trackerapp;


public class Model {
    private String name,active,confirmed,migratedother,deceased,recovered,dconfirmed,ddeceased,drecovered;

    public Model(String name, String active, String confirmed, String migratedother, String deceased, String recovered, String dconfirmed, String ddeceased, String drecovered) {
        this.name = name;
        this.active = active;
